...
class Skin():
    def __init__(self,path_to_mesh, joints_of_bone, scale = 1, constant_weight = False, color = 'green'):
        self.scale = scale
    ...
    def calculate_weights_dist(self):        
        self.weights = np.vstack([joint.bone.calculate_dist_from_bone(self.ptcloud_skin) for joint in self.bones]).T
